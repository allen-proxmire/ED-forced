...
20. **Empirical Predictions outreach trio (2026-05-17 Zenodo batch B; entries 26–28)** brings Zenodo total to **28 entries**. Three papers in `physics-papers/predictions/`: **(#26) Paper_ED_Predictions_Bundle** — primary outreach paper, BTFR-led wedge, bundles 13 predictions; **(#27) Paper_ED_Postdictions_PassedTests** — UDM data-match credibility anchor (self-authored Zenodo preprint, NOT peer-reviewed — a postdiction) + GW170817 (the one passed test) + 4 further postdictions; **(#28) Paper_ED_FRAP_Template** — pre-registered protocol + template, sections 6-9 placeholder pending experimental execution (v2 follows after FRAP run completes at Creative Proteomics CIBR).
...
**Summary by batch:**
- **2026-05-05:** 1 entry (UDM self-authored Zenodo preprint — not peer-reviewed)
