...
- **[`ED_TieredClaims_Master.xlsx`](ED_TieredClaims_Master.xlsx)** — every load-bearing claim, its paper, its exact tier (one of 19), its falsifier, and its status. Sortable. The ground-truth register.
...
- **Live program map:** ED_TieredClaims_Master.xlsx
