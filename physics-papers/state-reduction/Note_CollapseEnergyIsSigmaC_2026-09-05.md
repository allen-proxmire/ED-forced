...
**This is recorded as a consequence to check, explicitly not as a prediction.** Whether `Θ_{12}` is controllable, fixed by the preparation, or randomised in a real superposition is settled by nothing here, and **if it randomises, the dependence averages away and the difference is unobservable.** Establishing which of those holds is the work; the arc's standing caution on banking a distinctive-looking result applies with full force.
