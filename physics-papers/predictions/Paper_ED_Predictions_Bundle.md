...
Composition: $a_0 = cH_0 \cdot (1/(2\pi)) = cH_0/(2\pi)$. The factor of $2\pi$ is **geometrically forced** by azimuthal-Fourier-mode normalization, not phenomenologically fit.
