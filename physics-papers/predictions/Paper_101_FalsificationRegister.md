...
| 11 | **FRAP `α_R = 1/6`** (ML 4.4) + **AFM dewetting invariant −1.30** (4.5) | porous-medium front `R∼t^{1/6}`, not Fickian `t^{1/2}`; motif-ratio median −1.30 | Fickian diffusion `t^{1/2}`; no invariant | benchtop, ~$500–1500, weeks | protocol-ready; independent re-confirmations of the (peer-reviewed) UDM law |
