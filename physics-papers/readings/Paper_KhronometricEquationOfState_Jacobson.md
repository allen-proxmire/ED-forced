...
1. **This writes out a derivation whose verdict is already established, not a new verdict.** The companion paper `Paper_GravityAsEquationOfState` §6 states, at literature-grounded tier, that ED's local Jacobson derivation is *cleanly equilibrium and reaches the full Einstein equation*. **We have not found** — in ED or in the Einstein-aether literature — a worked **local-Rindler `δQ = TdS`** derivation for a khronometric theory. *(Narrowed 2026-09-05 from* “**Nobody** has actually written out”*, which was over-broad in two ways. First, **a negative-existence claim about a literature cannot be verified**, so the honest form is what we have and have not found. Second, it invites a reader to think of work it does not actually cover: **Einstein-aether horizon thermodynamics is a developed subfield** — Berglund, Bhattacharyya & Mattingly, *Towards thermodynamics of universal horizons in Einstein-æther theory*, PRL **110**, 071301 (2013), establishes a first law and an entropy for universal horizons. **That is a different object from what this article does** — a global first law at a universal horizon, rather than deriving field equations from a local Clausius relation on Rindler wedges — and the distinction is exactly what the claim must state rather than leave to the reader. Gravity ledger Staleness #61.)* This article does that, for ED's specific *luminal-cone* class, making the verdict explicit and checkable.
