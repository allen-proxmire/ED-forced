...
- **Family companions:** `Paper_GravityAsEquationOfState.md` (Jacobson; the thermal `1/4`), `Paper_GravityAsHorizonEquipartition.md` (Padmanabhan), `Paper_KhronometricEquationOfState.md`, `Paper_InducedGravityArena.md` (Sakharov), `Paper_MoreThanAnalogy.md` (analogue gravity); `README.md`.
